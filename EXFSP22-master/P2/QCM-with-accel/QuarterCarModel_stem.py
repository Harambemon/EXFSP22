...
class CarController():
    ...
    def OptimizeSuspension(self):
        ...
        """
        #Step 1:
        self.set(doCalc=False) # setting parameters


        #Step 2:
        x0 = [self.model.mink1, self.model.c1, self.model.mink2] #initial values for k1,c1,k2

         #Step 3:

        answer = minimize(self.SSE, x0, method='Nelder-Mead') # use Nelder-Mead method to find min
        self.view.updateView(self.model)
        return answer#OptimizeSuspension
